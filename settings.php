...
<form method="post" class="row g-4">
  ...
  <div class="col-12">
    <div class="card shadow-sm"><div class="card-body row g-3">
      ...
      <div class="col-12"><div class="alert alert-info small mb-0">SMTP password and API key are stored in <code>.env</code> for security and are not shown here.</div></div>
    </div></div>
  </div>
