...
function app_config(?string $key = null, mixed $default = null): mixed
{
    ...
    if ($config === null) {
        ...
        $config = [
            ...
            'mail_from_email' => (string) env_value('MAIL_FROM_EMAIL', 'hello@atlasbiolabs.co'),
            'mail_reply_to' => (string) env_value('MAIL_REPLY_TO', 'hello@atlasbiolabs.co'),
            ...
            'rfq_api_token' => (string) env_value('RFQ_API_TOKEN', env_value('ATLAS_BOT_API_TOKEN', '')),
            'atlas_bot_api_token' => (string) env_value('ATLAS_BOT_API_TOKEN', ''),
            'admin_email' => (string) env_value('ADMIN_EMAIL', 'hello@atlasbiolabs.co'),
            'business_address' => (string) env_value('BUSINESS_ADDRESS', 'Atlas BioLabs, United States'),
